...
/* renamed from: d9 */
public class C0369d9 implements ActionMode.Callback {

    /* renamed from: a */
    public final ActionMode.Callback f1880a;

    /* renamed from: b */
    public final TextView f1881b;

    /* renamed from: c */
    public Class<?> f1882c;

    /* renamed from: d */
    public Method f1883d;
    ...
    public C0369d9(ActionMode.Callback callback, TextView textView) {
        this.f1880a = callback;
        this.f1881b = textView;
    }

    public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f1880a.onActionItemClicked(actionMode, menuItem);
    }

    public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f1880a.onCreateActionMode(actionMode, menu);
    }

    public void onDestroyActionMode(ActionMode actionMode) {
        this.f1880a.onDestroyActionMode(actionMode);
    }
    ...
    public boolean onPrepareActionMode(android.view.ActionMode r13, android.view.Menu r14) {
        /*
            r12 = this;
            android.widget.TextView r0 = r12.f1881b
            android.content.Context r0 = r0.getContext()
            android.content.pm.PackageManager r1 = r0.getPackageManager()
            boolean r2 = r12.f1885f
            ...
            r12.f1882c = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            ...
            r12.f1883d = r2     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            r12.f1884e = r4     // Catch:{ ClassNotFoundException | NoSuchMethodException -> 0x002b }
            goto L_0x0032
        L_0x002b:
            r2 = 0
            r12.f1882c = r2
            ...
            r12.f1884e = r5
        L_0x0032:
            boolean r2 = r12.f1884e     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.Class<?> r2 = r12.f1882c     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            boolean r2 = r2.isInstance(r14)     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            if (r2 == 0) goto L_0x0041
            java.lang.reflect.Method r2 = r12.f1883d     // Catch:{ IllegalAccessException | NoSuchMethodException | InvocationTargetException -> 0x0129 }
            goto L_0x004f
        L_0x0041:
        ...
        L_0x00d6:
            ...
            android.widget.TextView r9 = r12.f1881b
        ...
        L_0x010e:
            ...
            goto L_0x00d6
        L_0x0129:
            android.view.ActionMode$Callback r0 = r12.f1880a
            boolean r13 = r0.onPrepareActionMode(r13, r14)
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: p000.C0369d9.onPrepareActionMode(android.view.ActionMode, android.view.Menu):boolean");
    }
}
