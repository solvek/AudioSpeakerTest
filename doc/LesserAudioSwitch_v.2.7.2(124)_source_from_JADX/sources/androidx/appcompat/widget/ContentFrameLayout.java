...
public class ContentFrameLayout extends FrameLayout {
    ...
    /* renamed from: b */
    public TypedValue f325b;

    /* renamed from: c */
    public TypedValue f326c;

    /* renamed from: d */
    public TypedValue f327d;

    /* renamed from: e */
    public TypedValue f328e;

    /* renamed from: f */
    public TypedValue f329f;

    /* renamed from: g */
    public TypedValue f330g;

    /* renamed from: h */
    public final Rect f331h = new Rect();
    ...
    /* renamed from: a */
    public void mo338a(Rect rect) {
        fitSystemWindows(rect);
    }

    public TypedValue getFixedHeightMajor() {
        if (this.f329f == null) {
            this.f329f = new TypedValue();
        }
        return this.f329f;
    }
    ...
    public void onAttachedToWindow() {
        ...
        C0055a aVar = this.f332i;
        if (aVar != null) {
            ((C1229v) aVar).getClass();
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        C0055a aVar = this.f332i;
        if (aVar != null) {
            C1079s sVar = ((C1229v) aVar).f4690a;
            C0802m2 m2Var = sVar.f4087l;
            if (m2Var != null) {
                m2Var.mo241j();
            }
            if (sVar.f4092q != null) {
                sVar.f4081f.getDecorView().removeCallbacks(sVar.f4093r);
                if (sVar.f4092q.isShowing()) {
                    try {
                        sVar.f4092q.dismiss();
            ...
            sVar.mo4325I();
            C1435z0 z0Var = sVar.mo4330N(0).f4124h;
            if (z0Var != null) {
                z0Var.mo5236c(true);
            }
        }
    ...
    public void onMeasure(int r14, int r15) {
        ...
        L_0x0017:
            ...
            android.util.TypedValue r10 = r13.f328e
            goto L_0x002e
        L_0x002c:
            android.util.TypedValue r10 = r13.f327d
        L_0x002e:
        ...
        L_0x0048:
            if (r10 <= 0) goto L_0x0060
            android.graphics.Rect r11 = r13.f331h
            int r12 = r11.left
            int r11 = r11.right
            int r12 = r12 + r11
            int r10 = r10 - r12
        ...
        L_0x0061:
            ...
            android.util.TypedValue r5 = r13.f329f
            goto L_0x006a
        L_0x0068:
            android.util.TypedValue r5 = r13.f330g
        L_0x006a:
        ...
        L_0x009a:
            ...
            android.util.TypedValue r1 = r13.f326c
            goto L_0x00b0
        L_0x00ae:
            android.util.TypedValue r1 = r13.f325b
        L_0x00b0:
        ...
        L_0x00ca:
            ...
            android.graphics.Rect r1 = r13.f331h
            int r2 = r1.left
            int r1 = r1.right
            int r2 = r2 + r1
            int r0 = r0 - r2
    ...
    public void setAttachListener(C0055a aVar) {
        this.f332i = aVar;
    }
}
