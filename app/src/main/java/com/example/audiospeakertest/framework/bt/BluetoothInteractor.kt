...
class BluetoothInteractor @Inject constructor(@ApplicationContext private val context: Context){
    ...
    fun getDevice(address: String) = adapter.getRemoteDevice(address)
